...
# To install these in vagrant box
...
#Edit pg_hba.conf to allow postgres to external systems
sudo vim /var/lib/pgsql/data/pg_hba.conf
host    all             all             0.0.0.0/0            password

#Edit postgresql.conf - to make the postgres port 5432 to listen from external systems
